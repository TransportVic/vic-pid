...
import { MetroPlatformStoppingPattern, VLinePlatformStoppingPattern } from '../static/scripts/metro-lcd/platform.mjs'
...
describe('The stop splitting function - FSS Platform', () => {
  it('Richmond - Westall', () => {
    ...
    expect(splitStops(MetroPlatformStoppingPattern, stops)).to.deep.equals([
      [
        'Richmond',
        'South Yarra',
        'Hawksburn',
  ...
  it('Caulfield - Bairnsdale', () => {
    ...
    expect(splitStops(VLinePlatformStoppingPattern, stops)).to.deep.equals([
      [
        'Caulfield',
        'Carnegie',
        'Murrumbeena',
